			...
			columns: [{
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
									<div class="kt-user-card-v2__details">\
										<span href="#" class="kt-user-card-v2__name">' + '405' + '</span>\
									</div>\
								</div>';
					return output;
				}
				...
				template: function(data, i) {
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
									<div class="kt-user-card-v2__details">\
										<span href="#" class="kt-user-card-v2__name">' + 'Stock/Load Roof' + '</span>\
									</div>\
								</div>';
					return output;
				}
				...
				template: function(data, i) {
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
									<div class="kt-user-card-v2__details">\
										<span href="#" class="kt-user-card-v2__name">' + '6' + '</span>\
									</div>\
								</div>';
					return output;
				}
				...
				template: function(data, i) {
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
									<div class="kt-user-card-v2__details">\
										<span href="#" class="kt-user-card-v2__name">' + '1000' + '</span>\
									</div>\
								</div>';
					return output;
				}
				...
				template: function(data, i) {
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
									<div class="kt-user-card-v2__details">\
										<span href="#" class="kt-user-card-v2__name">' + 'SF' + '</span>\
									</div>\
								</div>';
					return output;
				}
				...
				template: function(data, i) {
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
									<div class="kt-user-card-v2__details">\
										<span href="#" class="kt-user-card-v2__name">' + '12' + '</span>\
									</div>\
								</div>';
					return output;
				}
				...
				template: function(data, i) {
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
										<span href="#" class="kt-user-card-v2__name">' + 'sample comments...' + '</span>\
								</div>';
					return output;
				}
			}
